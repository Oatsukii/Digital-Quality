...
<div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="float-left ml-2">
                    <h4><strong>Productos Lista de materiales</strong></h4>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="col-md-12"  id="s-productos_ldm">
                    <br>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                        <th scope="col">Id ProductoLDM</th>
                                ...
                                <tbody>
                                    <tr v-for="row in paginaCollection">
                                        <td v-text="row.id_ad_producto_ldm"></td>
    ...
    <script type="text/javascript" src="../js/s_servicio/sinc_producto_ldm.js"></script>
