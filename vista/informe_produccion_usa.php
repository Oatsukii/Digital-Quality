...
<div class="card" id="InformeProduccionUsa">

    <div class="card-header">
        <H4><strong>Informe Cofres a Producir USA</strong></H4>
    </div>
...
<script type="text/javascript" src="../js/informe-produccion-usa/informe-produccion-usa.js"></script>
