...
<div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="float-left ml-2">
                    <h4><strong>Producto Flujo</strong></h4>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="col-md-12"  id="s-producto-flujo">
                    <br>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                        <th scope="col">Id Producto FLujo</th>
                                        <th scope="col">Id Producto</th>
                                        <th scope="col">C&oacute;digo</th>
                                        <th scope="col">Empresa</th>
                                        <th scope="col">Activo</th>
                                        <th scope="col">Gastos Generales</th>
                                        <th scope="col">Gastos Administrativos</th>
                                        <th scope="col">Gastos Operaciones</th>
                                        <th scope="col">Gastos Ventas</th>
                                ...
                                <tbody>
                                    <tr v-for="row in paginaCollection">
                                        <td v-text="row.id_ad_producto_flujo"></td>
                                        <td v-text="row.id_adempiere_producto"></td>
                                        <td v-text="row.codigo"></td>
                                        <td v-text="row.id_adempiere_flujo"></td>
                                        <td v-text="row.empresa"></td>
                                        <td v-text="row.status_activo"></td>
                                        <td v-text="row.gastos_generales"></td>
                                        <td v-text="row.gastos_administrativos"></td>
                                        <td v-text="row.gastos_operacion"></td>
                                        <td v-text="row.gastos_ventas"></td>
                                        <td v-text="row.utilidad"></td>
    ...
    <script type="text/javascript" src="../js/s_servicio/sinc_producto_flujo.js"></script>
