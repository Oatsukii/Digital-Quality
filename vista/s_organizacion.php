...
<div class="container-fluid px-4">
    <h1 class="mt-4">ORGANIZACIONES</h1>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="col-md-12"  id="s-organizacion">
                    <br>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Id Adempiere</th>
                                        <th scope="col"></th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="row in OrganizacionCollection">
                                        <td v-text="row.id_s_organizacion"></td>
                                        <td v-text="row.nombre"></td>
                                        <td v-text="row.empresa"></td>
                                        <td v-text="row.descripcion"></td>
                                        <td v-text="row.segmento"></td>
                                        ...
                                        <td><button type="button" name="eliminar" class="btn btn-danger delete"  @click="eliminar(row.id_s_organizacion)">Eliminar</button></td>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <!--inicio del modal-->
                    <b-modal v-model="modalOrganizacion">
                        ...
                        <b-container fluid>
                            <div>
                                <b-form>
                                    ...
                                    <b-form-group class="mb-10 mt-10" label="Id Adempiere:">
                                        <b-form-input type="number" v-model="id_adempiere" required></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-10 mt-10" label="Segmento:">
                                        <b-form-input type="number" v-model="segmento" required></b-form-input>
                                    </b-form-group>

                                    <b-form-group  class="mb-10 mt-10" label="Contexto:">
                                        <b-form-input type="text" v-model="s_contexto" required></b-form-input>
                                    </b-form-group>

                                    <b-form-group  class="mb-10 mt-10" label="Descripci&oacute;n">
                                        <b-form-textarea  class="mb-10 mt-10" label="Descripci&oacute;n:" v-model="descripcion" rows="5" no-resize></b-form-textarea>
                                    </b-form-group>
    ...
    <script type="text/javascript" src="../js/s_organizacion/s_organizacion.js"></script>
