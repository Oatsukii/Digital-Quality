...
<div class="container-fluid px-4">
                    ...
                    <div class="col-sm-16 col-sm-offset-4">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="row in EmpresaCollection">
                                        <td v-text="row.id_s_empresa"></td>
                                        <td v-text="row.nombre"></td>
                                        <td v-text="row.descripcion"></td>
                                        <td v-text="row.status_activo"></td>
                                        <td v-text="row.id_adempiere_empresa"></td>
                                        <td><button type="button" name="editar" class="btn btn-success edit"  @click="abrirModal('',row)">Editar</button></td>
                                        <td><button type="button" name="eliminar" class="btn btn-danger delete"  @click="eliminar(row.id_s_empresa)">Eliminar</button></td>
                                </tbody>
                            </table>
                        </div>
                    </div>
                            ...
                            <div>
                                <b-form>
                                    ...
                                    <b-form-group class="mb-10 mt-10" label="Id Adempiere:">
                                        <b-form-input type="text" v-model="id_adempiere" required></b-form-input>
                                    </b-form-group>
    ...
    <script type="text/javascript" src="../js/s_empresa/s_empresa.js"></script>
