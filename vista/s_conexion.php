...
<div class="container-fluid px-4">
    <h1 class="mt-4">CONEXI&Oacute;N</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <i class="fas fa-table me-1"></i>Conexi&oacute;n
            </div>
            <div class="card-body">
    
                <div class="col-md-12"  id="s-conexion">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                        <th scope="col">Nombre Conexi&oacute;n</th>
                                ...
                                <tbody>
                                    <tr v-for="row in ConexionCollection">
                                        <td v-text="row.id_s_conexion"></td>
                                        ...
                                        <td><button type="button" name="eliminar" class="btn btn-danger delete"  @click="eliminar(row.id_s_conexion)">Eliminar</button></td>
                                </tbody>
                            </table>
                        </div>
                    </div>
                            ...
                            <div>
                                <b-form>
                                    <b-form-group  class="mb-10 mt-10" label="Nombre:">
                                        <b-form-input type="text" v-model="nombre_conexion" require></b-form-input>
                                    </b-form-group>
    ...
    <script type="text/javascript" src="../js/s_conexion/s_conexion.js"></script>
