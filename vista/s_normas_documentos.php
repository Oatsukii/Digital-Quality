...
<div class="container-fluid px-4">
    <h1 class="mt-4">Certificaciones</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <i class="fas fa-table me-1"></i>Certificaciones
            </div>
            <div class="card-body">
                    ...
                    <div class="col-sm-16 col-sm-offset-4">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="row in categoriaCollection">
                                        <td v-text="row.id_s_norma_documento"></td>
                                        <td v-text="row.nombre_norma"></td>
                                        <td v-text="row.empresa"></td>
                                        <td v-text="row.descripcion"></td>
                                        <td v-text="row.status_activo"></td>
                                        <td><a v-bind:href="`${url +`?norm=`+row.id_s_norma_documento}`">Agregar Documentos</a></td>
                                        <td><button type="button" name="editar" class="btn btn-success edit"  @click="abrirModal('',row)">Editar</button></td>
                                        <td><button type="button" name="eliminar" class="btn btn-danger delete"  @click="eliminar(row.id_s_norma_documento)">Eliminar</button></td>
                                </tbody>
                            </table>
                        </div>
                    </div>
                            ...
                            <div>
                                <b-form>
                                        ...
                                        <b-form-select v-model="id_s_empresa" class="mb-3" >
                                            ...
                                            <option v-for="rows in empresaColeccion" :value="rows.id_s_empresa">
                                                {{ rows.nombre }}
                                            </option>
                                        </b-form-select >
                                        
                                        <label>Normas</label>
                                        <b-form-select v-model="id_s_norma" class="mb-3" >
                                            <option value="">Selecciona una opci&oacute;n</option>
                                            <option v-for="rows in normasColeccion" :value="rows.id_s_norma">
                                                {{ rows.nombre_norma }}
                                            </option>
                                        </b-form-select >

                                        <b-form-group class="mb-10 mt-10" label="Descripci&oacute;n:">
                                            <b-form-textarea  class="mb-10 mt-10" label="Descripci&oacute;n:" v-model="descripcion" rows="5" no-resize>
                                        </b-form-group>
    ...
    <script type="text/javascript" src="../js/s_normas_documentos/s_normas_documentos.js"></script>
