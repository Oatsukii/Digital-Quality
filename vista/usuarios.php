                                      ...
                                      <table class="table table-bordered">
                                          <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <td><button type="button" name="editar" class="btn btn-success edit"  @click="abrirModal('',usuario.id_usuario)">Editar</button></td>
                                                <td><button type="button" name="reiniciar" class="btn btn-info reset"  @click="cambiarcontrasenia(usuario.id_usuario)">Reiniciar</button></td>
                                            </tbody>
                                      </table>  
                        </div>
                  </div>
                      ...
                      <div v-for="r in rols">
                        <b-form>
                          <b-form-group class="mb-0 mt-0">
                                  <b-form-checkbox v-model="r.selected" v-bind:id="'check_' + r.id_rol">{{ r.nombre }}</b-form-checkbox>
                          </b-form-group>
                        </b-form>
                      </div>
                    </b-container>
