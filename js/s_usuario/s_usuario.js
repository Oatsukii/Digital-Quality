 ...
 var application_usuario = new Vue({
    ...
    listar(){
      ...
      comprobar(id){
        ...
        if(this.first_name != '' && this.paternal_name != '' && this.maternal_name != '' && this.user != '' && this.id_s_empresa != ''){
		...
		agregar(){
			...
			axios.post('../controladores/c_s_usuario.php',params)
			.then((response)=>{
     ...
     obtenerDato(id){
        ...
        accion:'obtenerDato',
			...
			.then((response)=>{
        //console.log(response.data);
        this.id_s_empresa = response.data.id_s_empresa
  ...
  async asignaRol(employee){ 
    ...
    const params = {
      idusuario:this.empleadoSeleccionado.id_s_usuario,
      accion:'rolusuario',
    };

    const response = await axios.post('../controladores/c_s_usuario_rol.php',params)
  ...
  async guardarRol(){ 
    ...
    const response = await axios.post('../controladores/c_s_usuario_rol.php', params).then(function(response){ return response.data });
    //console.log(response);

    for (let index = 0; index < this.rols.length; index++) {
      const element = this.rols[index];
      if (element.selected) {
        const response2 = await axios.post('../controladores/c_s_usuario_rol.php', {  
          accion:'agregar'
          ,id_s_usuario: this.empleadoSeleccionado.id_s_usuario
          ,id_s_rol: element.id_s_rol }).then(function(response)
          { 
