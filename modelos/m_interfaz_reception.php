...
class ModeloInterfazRecepcion extends ConexionDB
{
    public const LLAVE = 'DevTI';

    public static function listarInterfazRecepcionM($datos)
	{
		static $query = "SELECT
        ...
        try {
            ...
            */
            ...
            foreach ($array_destino as $d) {
                ...
                $base_destino = $Seguridad->decrypt($d['base_destino'],ModeloInterfazRecepcion::LLAVE);
                $usuario_destino = $Seguridad->decrypt($d['usuario_destino'],ModeloInterfazRecepcion::LLAVE);
                $contrasenia_destino = $Seguridad->decrypt($d['contrasenia_destino'],ModeloInterfazRecepcion::LLAVE);
            ...
            */           
            ...
            $query = "SELECT * FROM AD_Recepcion(".$id_documento .",". $nuevopedimento .",". $fechapedimento ."
