...
class ModeloNormasDocumentos extends ConexionDB
{
	...
	{
		static $query = "SELECT docl.id_s_norma_documento_linea, docl.creado, docl.creadopo, docl.actualizado
                                ,docl.actualizadopor, docl.id_s_norma_documento, docl.esactivo, docl.nombre_archivo
                                ,docl.fecha_disponible, encode(docl.archivo, 'base64')AS archivo
                                ,n.nombre_norma
                                ,docl.esactivo
                        ...
                        WHERE docl.id_s_norma_documento = :id_s_norma_documento
                        ";
    ...
    {
        try {
            static $tabla = "d_documentos_lista";
